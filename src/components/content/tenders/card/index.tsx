...
export const TendersCard: React.FC<TendersCardProps> = ({
  ...
  return (
    <div className="flex h-[calc(33.333333%-(20px/3))] w-[calc(33.333333%)] animate-appearance">
      <div className="flex flex-col w-[calc(100%-20px)] h-[calc(100%-20px)] bg-[rgba(255,255,255,0.25)] rounded-2xl hover:bg-[rgba(255,255,255,0.35)] cursor-pointer transition-background overflow-hidden">
        ...
        <div className="flex mt-auto">
          <div
            ...
            onClick={() => fetchChangeFavouriteTender({id, favourite: !favourite})}
          >
            {favourite ? (
              <>
